...
if (knitr:::is_latex_output()) { fig_cap <- paste0("Global lighting strike density per month. <a \\href='",baseurl,"\\types-of-data.html#imperfect-distinctions'>Animated figure can be viewed in the web browser version of the textbook.</a> Skeeter, CC-BY-SA-4.0.")
