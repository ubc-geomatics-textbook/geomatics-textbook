...
![Income vs. household expenditures on Food by Census Subdivisions in BC.](images/03-income-v-food){.center}

![Income vs. Fraction of Income Spent on Food by Census Subdivisions in BC.](images/03-income-v-income-on-food){.center}
...
![Forest coverage map.](images/03-forest-for-the-trees.png){.center}
...
Some key considerations that influence which model is suited for which situations.  Images are in a separate folder.  I can bring over the ones that correspond to text I'll keep from this.

<iframe width=100% height=800px src='images/03-choice-of-model.html' frameBorder="0" >
...
#### Data Classification and Resolution: Raster and Vector Approaches {#box-text -}

I envisions making a more condensed and thought out version of this video to summarize a few key points regarding resolution, phenomena types, and data models.  This was just something I threw together last minute after I had to cancel class last minute.

<iframe width="560" height="315" src="https://www.youtube.com/embed/apak726770w?start=111" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
4. How do the raster and vector data models represent space differently?



3. What types phenomena (continuous fields/)
 do the raster data model and the vector data model represent spatial data?
4. Which spatial data models are better suited to which type of phenomena?
