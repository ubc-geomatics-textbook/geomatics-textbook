...
<!--chapter:end:06-overlay-and-proximity-analysis.Rmd-->
...
<!--chapter:end:09-raster-analysis-and-terrain-modelling.Rmd-->
...
<!--chapter:end:10-spatial-estimation.Rmd-->
...
<!--chapter:end:13-image-processing.Rmd-->
...
<!--chapter:end:14-image-analysis.Rmd-->
...
<!--chapter:end:16-data-integration.Rmd-->
...
<!--chapter:end:17-making-beautiful-maps.Rmd-->
