...
fig_cap <- paste("An example of choropleth map displaying vegetation diversity for each dissemination area in Vancouver. Animated figure can be viewed in the web browser version of the textbook. Lam, CC-BY-SA-4.0.")
m1
```
<br/>
