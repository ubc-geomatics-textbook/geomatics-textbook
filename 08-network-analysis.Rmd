...
#### Trees
In tree topologies, nodes are structured from a root node and arranged into edges that are similar to branches of a tree. This highly hierarchical structure create a sort of *parent - child* relationship amongst nodes. The spatial configuration of boat marinas are usually structures in tree-like topologies.
...
### Linear referencing
Linear referencing is used for finding the length of paths along the network [@ramsey23LinearReferencing2012].
...
#### Reach analysis
Reach techniques are commonly used to find the incidence of defined elements within a certain radius from a chosen node.
