...
Explore some of the LiDAR derivatives that we produced in the case study above. We can see how the maximum height (zmax) differs from the mean height (zmean) and areas where the standard deviations of heights are very different from one another.
...
# Load files
r_hmean <- raster(here::here("data", "hmean.tif"))
r_hmax <- raster(here::here("data", "hmax.tif"))
r_hsd <- raster(here::here("data", "hsd.tif"))

# Set colors and legend titles
pal1 <- colorNumeric(c("#fee090", "#fc8d59", "#d73027"), values(r_hmean),
                    na.color = "transparent")

pal2 <- colorNumeric(c("#FFFFCC", "#41B6C4", "#0C2C84"), values(r_hmax),
                    na.color = "transparent")

pal3 <- colorNumeric(c("#e5f5e0", "#a1d99b", "#1b7837"), values(r_hsd),
                     na.color = "transparent")
...
m = leaflet() %>%
  ...
  addLayersControl(overlayGroups = c("Mean Height", "Maximum Height", "Standard Deviation of Height"),
