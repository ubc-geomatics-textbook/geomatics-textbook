...
Explore some of the LiDAR derivatives that we produced in the case study above. We can see how the maximum height (zmax) differs from the mean height (zmean) and areas where the standar deviations of heights are very different from one another.
...
![Figure 15.X Example of all the metrics you can produce... replace this with a leaflet map in 'your turn' section below](images/15-las_metrics_2D.png){.center}
