...
```{r 04-census-geographies, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    ...
    knitr::include_graphics("images/04-census-geographies.png")
```
...
```{r 04-crooked-aerialphoto, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Example of how a linear feature can appear crooked in an aerial photograph that has not yet been orthorectified due to relief displacement.  ATTRIBUTION NEEDED.")
...
```{r 04-crooked-aerialphoto, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Example showing the availabiltiy of historical aerial photos in eastern Nefoundland at three time steps. ATTRIBUTION NEEDED.")
...
```{r 04-georeferencing-concept, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("The need for georeferencing illustrated conceptually. ATTRIBUTION NEEDED.")
    knitr::include_graphics("images/04-georeferencing-concept.png")
```
...
```{r 04-control-points, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("A comparison of A) a historical census map from 1931 with no graticule versus B) a 1961 census map with graticule representing latitude and longitude. Panel C) shows a close-up of the coordinate detail. ATTRIBUTION NEEDED.")
    knitr::include_graphics("images/04-control-points.png")
```
