...
![Figure 2.2 Diagram for measuring height above a datum](images/02-height.png){.center}
<br/>
...
![Figure 2.3 Spherical geodetic datum](images/02-geodetic-datum.png){.center}
<br/>
...
![Figure 2.4 Sphere versus ellipsoid](images/02-sphere-ellipsoid.png){.center}
<br/>
...
![Figure 2.5 Conceptual tidal datum for Canada](images/02-tidal-datum.png){.center}
<br/>
...
![Figure 2.6 Orthometric Height (H) is the ellipsoidal height (h) less the geoid height (N)](images/02-H-h-N.png){.center}
<br/>
...
![Figure 2.7 Thought experiment showing where water would be at rest within a tunnel through the geoid due to the equipotential force of gravity (g)](images/02-geoid-tunnel.png){.center}
<br/>
...
![Figure 2.10 Equivalent Tissot Indicatrix](images/02-equivalent-indicatrix.png){.center}
<br/>
...
[Figure 2.14. Close-up of a single UTM zone showing the central meridian and secants]
...
[Figure 2.15. Showing a UTM zone with the central meridian and annotated by false eastings/northings]
...
![Figure 2.16 Sinusoidal map projection with Tissot's Indicatrices in red](images/02-Sinusoidal-map.png){.center}
<br/>
...
![Figure 2.17 BC Environment Albers map projection with Tissot's Indicatrices in red](images/02-BC-Albers-map.png){.center}
<br/>
