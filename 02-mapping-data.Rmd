...
```{r 2-height, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Diagram for measuring height above a datum. Pickell, CC-BY-4.0.")
...
```{r 2-geodetic-datum, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Spherical geodetic datum. Pickell, CC-BY-4.0.")
...
```{r 2-sphere-ellipsoid, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Sphere versus ellispoid. Pickell, CC-BY-4.0.")
...
```{r 2-tidal-datum, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Conceptual tidal datum for Canada. Pickell, CC-BY-4.0.")
...
```{r 2-H-h-N, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Orthometric Height (H) is the ellipsoidal height (h) less the geoid height (N). Pickell, CC-BY-4.0.")
...
```{r 2-geoid-tunnel, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Thought experiment showing where water would be at rest within a tunnel through the geoid due to the equipotential force of gravity (g). Pickell, CC-BY-4.0.")
...
```{r 2-geocentric-geodetic-latitude, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Geocentric versus geodetic latitude. Pickell, CC-BY-4.0.")
...
```{r 2-reference-indicatrix, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Reference Tissot Indicatrix. Pickell, CC-BY-4.0.")
...
```{r 2-reference-equivalent, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Equivalent Tissot Indicatrix. Pickell, CC-BY-4.0.")
...
```{r 2-conformal-indicatrix, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Conformal Tissot Indicatrix. Pickell, CC-BY-4.0.")
...
```{r 2-Mercator-map, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Mercator map projection with Tissot's Indicatrices in red. Pickell, CC-BY-4.0.")
...
```{r 2-Sinusoidal-map, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Sinusoidal map projection with Tissot's Indicatrices in red. Pickell, CC-BY-4.0.")
...
```{r 2-BC-Albers-map, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("British Columbia Environment Albers map projection with Tissot's Indicatrices in red. Pickell, CC-BY-4.0.")
...
```{r 2-Azimuthal-map, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("North Pole Azimuthal map projection with Tissot's Indicatrices in red. Pickell, CC-BY-4.0.")
