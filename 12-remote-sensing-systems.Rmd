...
Though you are looking at a screen to read this, there are other objects you can see above, below, and beside it; if someone walks into the room behind you, you can turn your head to look at them. Everything you can see without standing up or leaning over is your *field of view*. Similarly, the field of view of a remote sensing system refers to everything in a scene it can detect without shifting its position. Field of view is negatively related to the spatial resolution of an image - a large field of view results in a larger pixel size and vice versa. It is also related to focal length as mentioned previously, but this is not particularly important for us to study.
