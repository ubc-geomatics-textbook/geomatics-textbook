...
```{r 00-book-cover, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Cover design by --, CC-BY-SA-4.0.")
...
- **Part 3** Chapters 10-16 focus on everything **Remote Sensing** including theory, systems, image processing and analysis, and LiDAR (light detection and ranging) as well as integrating data from different sources and types.
