...
<<<<<<< HEAD
**Figure 10.20.** \ref{fig:figs} Predicted basal area over the entire Fort Saint Johns TSA using five nearest neighbor projected over the province of British Columbia. Data from City of Vancouver and licensed under the Open Government License - Vancouver. 
=======
