...
if (knitr:::is_latex_output()) { fig_cap <- paste0("Concave alpha hull generates an alpha shape around a set of points. Online version of the figure is animated by alpha values from 0 to 1 by increments of 0.05. <a href='",baseurl,"topology-and-geocoding.html#convex-alpha-hulls-and-alpha-shapes'>Animated figure can be viewed in the web browser version of the textbook.</a> Pickell, CC-BY-SA-4.0.")
...
if (knitr:::is_latex_output()) { fig_cap <- paste0("The five Platonic solids are examples of regular, convex polyhedrons and multipatch geometries. From left to right: tetrahedron (4 faces); hexahedron (6 faces); octahedron (8 faces); dodecahedron (12 faces); and icosahedron (20 faces). <a href='",baseurl,"topology-and-geocoding.html#multipatch-geometries-1'>Animated figure can be viewed in the web browser version of the textbook</a>. @cyp_polyhedra_2005, CC-BY-SA-3.0.")
