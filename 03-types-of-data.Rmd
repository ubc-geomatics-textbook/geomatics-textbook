...
fig_cap <- paste0("Each flower is different, but no flower is 'more' or 'less' a flower than any of the others, CC-BY-SA-4.0.")
knitr::include_graphics("images/03-flowers-nominal.png")
```
```{r 3-nominal-opperations, echo=FALSE, out.width = '75%', fig.cap=fig_cap}
fig_cap <- paste0("Checking equality with flower species, CC-BY-SA-4.0.")
...
fig_cap <- paste0("We can see Yarrow is taller than her sister Shamsa, so we can rank these dogs by height. However, we haven't measured their heights, so we don't know how much taller Yarrow is than Shamsa, CC-BY-SA-4.0.")
...
fig_cap <- paste0("In this example, we see an alpine landscape in Garibalid Provinical Park, BC.  We can see patches of forest and patches of meadow.  But where, exactly, would we draw the boundary between these two landscape classes?, CC-BY-SA-4.0.")
...
fig_cap <- paste0("Representing space in the raster model vs. the vector model. Pickell, CC-BY-SA-4.0.")
...
fig_cap <- paste0("I think this one is pretty good, I use it in my lecture notes. Pickell, CC-BY-SA-4.0.")
