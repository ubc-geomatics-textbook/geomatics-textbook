# Chapter Title {#types-of-data}

**Ducks**, This chapter is about ducks
...
Just a name/category, no ranking or direction.
* Plant species
* Zoning category
...
More than a name, some sort of ranking, but no numerical scale/meaning, you cant take differences, 
* Relative sizes (short, medium, tall)
* Relative ages (young/old)
* Spice level

### Graded membership
 ... necessary?  I've not heard of?



### 3.1.4 Interval
### 3.1.5 Log-Interval
### 3.1.6 Extensive Ratio
### 3.1.7 Cyclical Ratio
### 3.1.8 Derived Ratio
### 3.1.9 Counts
#### 3.1.10  Absolute
