...
### Major Gaps {-}
* How to apply spatial network analysis for real-world problems?
* How to use network centrality measures to analyze spatial centrality?
* How to exemplify network topologies with other kinds of networks rather than computers?
...
```{r include=FALSE}
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'stringr', 'rmarkdown', 'htmlwidgets', 'webshot', 'DT',
