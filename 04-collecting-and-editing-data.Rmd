...
![Figure 4.4 Example of how a linear feature can appear crooked in an aerial photograph that has not yet been orthorectified due to relief displacement.](images/04-crooked-aerialphoto.png){.center}
...
![Figure 4.5 Example showing the availabiltiy of historical aerial photos in eastern Nefoundland at three time steps.](images/04-accessing-aerial-photos.png){.center}
...
![Figure 4.6 The need for **georeferencing** illustrated conceptually](images/04-georeferencing-concept.png){.center} 
...
![Figure 4.7 A comparison of A) a historical census map from 1931 with no graticule versus B) a 1961 census map with graticule representing latitude and longitude. Panel C) shows a close-up of the coordinate detail.  ](images/04-control-points.png){.center}
