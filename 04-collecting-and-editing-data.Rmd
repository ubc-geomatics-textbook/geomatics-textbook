...
```{r 04-control-points, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("A comparison of (A) an historical census map from 1931 with no graticule versus (B) a 1961 census map with graticule representing latitude and longitude. Panel C shows a close-up of the coordinate detail. Sutherland, CC-BY-4.0.")
