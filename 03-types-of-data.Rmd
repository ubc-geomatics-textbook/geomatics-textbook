...
![My own images, can update text/font/styling as necessary.  Very rough draft](images/03-vector-points.png){.center}
...
![https://www.oercommons.org/courses/introduction-to-geospatial-concepts/view - might be easier to recreate our own if the logo is an issue?](images/03-vector-attributes.png){.center}
