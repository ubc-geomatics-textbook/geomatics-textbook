...
if (knitr:::is_latex_output()) { fig_cap <- paste0("Graph representing connection between Metro Vancouver rapid and frequent transit lines. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-vancouver-transit-graph.png")
} else { fig_cap <- paste0("Graph representing connection between Metro Vancouver rapid and frequent transit lines.")
data <- data.frame(
...
if (knitr:::is_latex_output()) { fig_cap <- paste0("Example of directed graph for social relationships. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-directed-graph.png")
} else { fig_cap <- paste0("Example of directed graph for social relationships.")
...
```{r 8-vancouver-rail-transit, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Rail transit line in Vancouver. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-vancouver-rail-transit.png")
} else { fig_cap <- paste0("Rail transit line in Vancouver. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver")
...
```{r 8-stanley-park-seawall, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Ring of the Stanley Park seawall. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-stanley-park-seawall.png")
} else { fig_cap <- paste0("Ring of the Stanley Park seawall. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver")
...
```{r 8-tree-canopy-mesh, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Tree canopy mesh. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-tree-canopy-mesh.png")
} else { fig_cap <- paste0("Tree canopy mesh. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver")
...
```{r 8-origin-destination, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Possible origin-destination commutes between municipalities within Metro Vancouver. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-origin-destination.png")
} else { fig_cap <- paste0("Possible origin-destination commutes between municipalities within Metro Vancouver. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver")
...
```{r 8-spatial-structure-garden, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Spatial structure of a concentric garden at UBC. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-spatial-structure-garden.png")
} else { fig_cap <- paste0("Spatial structure of a concentric garden at UBC. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver.")
...
```{r 8-connections-houses-streets, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Connections between houses and streets. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-connections-houses-streets.png")
} else { fig_cap <- paste0("Connections between houses and streets. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver")
...
```{r 8-boat-marina, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Tree spatial structure of a boat marina. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-boat-marina.png")
} else { fig_cap <- paste0("Tree spatial structure of a boat marina. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver.")
...
```{r 8-fraser-river-flows, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Graph representing Fraser River Flows. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-fraser-river-flows.png")
} else { fig_cap <- paste0("Graph representing Fraser River Flows. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver")
...
```{r 8-least-cost-path, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Least cost path (in terms of distance) between two points. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-least-cost-path.png")
} else { fig_cap <- paste0("Least cost path (in terms of distance) between two points. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver")
...
```{r 8-reach-analysis, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Reachable segments within multiple distance radii. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-reach-analysis.png")
} else { fig_cap <- paste0("Reachable segments within multiple distance radii. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver")
...
```{r 8-closeness-centrality-UBC, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Closeness centrality of the street intersections at UBC. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-closeness-centrality-UBC.png")
} else { fig_cap <- paste0("Closeness centrality of the street intersections at UBC. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver")
...
```{r 8-betweenness-centrality, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Betweenness centrality of street segments at UBC. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-betweenness-centrality.png")
} else { fig_cap <- paste0("Betweenness centrality of street segments at UBC. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver")
...
```{r 8-closeness-centrality-vancouver, echo=FALSE, fig.cap=fig_cap}
if (knitr:::is_latex_output()) { fig_cap <- paste0("Closeness centrality of parks and green spaces at the City of Vancouver. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.")
knitr::include_graphics("images/08-closeness-centrality-vancouver.png")
} else { fig_cap <- paste0("Closeness centrality of parks and green spaces at the City of Vancouver. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver")
