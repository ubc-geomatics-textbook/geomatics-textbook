...
```{r 12-scan-angle, fig.cap = fig_cap, out.width="100%", echo = FALSE}
fig_cap <- paste0("Scan angle. Pickell, CC-BY-SA-4.0.")
knitr::include_graphics(here::here("images", "12-scan-angle.png"))
```
<br/>

```{r 12-cross-track-along-track, fig.cap = fig_cap, out.width="100%", echo = FALSE}
...
fig_cap <- paste0("Oblique image of a forest harvest near Cold Lake in Saskatchewan. Pickell, CC-BY-SA-4.0.")
...
fig_cap <- paste0("Image pair of Athabasca Glacier from Wilcox Pass in Jasper National Park, Alberta, Canada. The historical image take in 1918 by A.O. Wheeler and the modern image take nearly a hundred years later in 2011 by the Mountain Legacy Project. <a href='",baseurl,"#12-mountain-legacy-project'>Animated figure can be viewed in the web browser version of the textbook.</a> Historical imagery courtesy of Library and Archives Canada. Modern image courtesy of the [Mountain Legacy Project](https://explore.mountainlegacy.ca/), CC-BY-SA-4.0.")
...
fig_cap <- paste0("Pitch is the rotation of the aircraft over the axis of the wings, roll is the rotation of the aircraft over the axis of the fuselage, and yaw is the rotation of the aircraft over the axis of vertical axis that is perpendicular to the fuselage. [Jrvz](https://en.wikipedia.org/wiki/Aircraft_principal_axes#/media/File:Yaw_Axis_Corrected.svg), CC-BY-SA 3.0.")
...
RADARSAT 1/2 and Constellation RADARSAT Mission
