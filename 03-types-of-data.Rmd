...
(ref:3-elevation-caption) Elevation of the Sunshine Coast in BC, from the NRCAN DEM (google earth engine) [@nrcan_canadian_2021].
...
if (knitr:::is_latex_output()) { fig_cap <- paste0("Global lighting strike density per month. Skeeter, CC-BY-SA-4.0.  Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/types-of-data.html")
...
```{r 3-interval-ratio-temperature, echo=FALSE, fig.cap=fig_cap, out.width='75%'}
