...
```{r 15-LiDAR_System, fig.cap = fig_cap, out.width="50%", echo = FALSE}
fig_cap <- paste("Overview of the components of a LiDAR System.")
knitr::include_graphics(here::here("images", "15-LiDAR_System.png"))
```
...
```{r 15-Concept_of_LiDAR, fig.cap = fig_cap, out.width="80%", echo = FALSE}
fig_cap <- paste("Concept of LiDAR.")
knitr::include_graphics(here::here("images", "15-Concept_of_LiDAR.png"))
```
...
```{r 15-las_denoise, fig.cap = fig_cap, out.width="80%", echo = FALSE}
fig_cap <- paste("An example of a typical LiDAR point cloud containing 3.14 million points at approximately 80 p/m^2^.")
knitr::include_graphics(here::here("images", "15-las_denoise.png"))
```
...
```{r 15-high_low_point_density, fig.cap = fig_cap, out.width="80%", echo = FALSE}
fig_cap <- paste("A cross section of a high density point cloud (A, X p/m^2^), and a lower density point cloud (B, 1 p/m^2^).")
knitr::include_graphics(here::here("images", "15-high_low_point_density.png"))
```
...
```{r 15-LiDAR_Unit, fig.cap = fig_cap, out.width="70%", echo = FALSE}
fig_cap <- paste("An example of a LiDAR Unit.")
knitr::include_graphics(here::here("images", "15-LiDAR_Unit.jpg"))
```
...
```{r 15-XYZ_coordinates, fig.cap = fig_cap, out.width="70%", echo = FALSE}
fig_cap <- paste("An on board GPS is required to for providing an accurate location of the LiDAR scanner.")
knitr::include_graphics(here::here("images", "15-XYZ_coordinates.jpg"))
```
...
```{r 15-LiDAR_on_Drone_2, fig.cap = fig_cap, out.width="70%", echo = FALSE}
fig_cap <- paste("Drone mounted LiDAR.")
knitr::include_graphics(here::here("images", "15-LiDAR_on_Drone_2.jpg"))
```
...
```{r 15-LiDAR_Platforms, fig.cap = fig_cap, out.width="90%", echo = FALSE}
fig_cap <- paste("LiDAR Platforms 1:SOURCE, 2:SOURCE, 3:SOURCE, 4:SOURCE.")
knitr::include_graphics(here::here("images", "15-LiDAR_Platforms.png"))
```
...
```{r 15-LiDAR_Discrete_Full_Waveform, fig.cap = fig_cap, out.width="80%", echo = FALSE}
fig_cap <- paste("Differents in the response between discrete echo and full waveform LiDAR.")
knitr::include_graphics(here::here("images", "15-LiDAR_Discrete_Full_Waveform.png"))
```
...
```{r 15-las_dem, fig.cap = fig_cap, out.width="70%", echo = FALSE}
fig_cap <- paste("A digital elevation model (DEM) produced from LiDAR")
knitr::include_graphics(here::here("images", "15-las_dem.png"))
```
...
```{r 15-las_CHM_2D, fig.cap = fig_cap, out.width="70%", echo = FALSE}
fig_cap <- paste("A canopy height model (CHM), also known as a digital surface model (DSM) produced from LiDAR")
knitr::include_graphics(here::here("images", "15-las_CHM_2D.png"))
```
...
```{r 15-las_hmax_2D, fig.cap = fig_cap, out.width="70%", echo = FALSE}
fig_cap <- paste("Maximum heights of 10 meter cells using an area-based approach.")
knitr::include_graphics(here::here("images", "15-las_hmax_2D.png"))
```
...
```{r 15-Processing_Flowchart, fig.cap = fig_cap, out.width="90%", echo = FALSE}
...
knitr::include_graphics(here::here("images", "15-Processing_Flowchart.png"))
```
```{r 15-las_treetops, fig.cap = fig_cap, out.width="80%", echo = FALSE}
fig_cap <- paste("Example of tree tops detected using the `find_trees` function." )
knitr::include_graphics(here::here("images", "15-las_treetops.png"))
```
...
```{r 15-las_normalize, fig.cap = fig_cap, out.width="60%", echo = FALSE}
fig_cap <- paste("A normalized point cloud." )
knitr::include_graphics(here::here("images", "15-las_normalize.png"))
```
...
```{r 15-las_segmented, fig.cap = fig_cap, out.width="60%", echo = FALSE}
fig_cap <- paste("A segmented point cloud using the algorithm based on Dalponte and Coomes (2016)")
knitr::include_graphics(here::here("images", "15-las_segmented.png"))
```
...
```{r files, echo=FALSE, warning=FALSE, include =FALSE}
...
```{r map , echo=FALSE, fig.cap = fig_cap}

fig_cap <- paste("Figure 15.X: Explore different area-based metrics produced in the case study above")
