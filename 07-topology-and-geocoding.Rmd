...
if (knitr:::is_latex_output()) { fig_cap <- paste0("Non-planar topology of 36 indigenous territories overlapping Vancouver Island, British Columbia. Data from @native_land_native_nodate, CC0. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/topology-and-geocoding.html.")
knitr::include_graphics("images/07-native-land-leaflet.png")
} else { fig_cap <- paste0("Non-planar topology of 36 indigenous territories overlapping Vancouver Island, British Columbia. Data from @native_land_native_nodate, CC0.")
m
}
```
