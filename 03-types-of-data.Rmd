...
fig_cap <- paste0("Elevation of the Sunshine Coast in BC, from the NRCAN DEM (google earth engine). Skeeter, CC-BY-SA-4.0.")
...
fig_cap <- paste0("The west coast of Vancouver Island (just a screen grab from Arc, might want something better. Skeeter, CC-BY-SA-4.0.")
...
fig_cap <- paste0("We can see Yarrow is taller than her sister Shamsa, so we can rank these dogs by height.  However, we haven't measured their heights, so we don't know how much taller Yarrow is than Shamsa. Skeeter, CC-BY-SA-4.0.")
...
fig_cap <- paste0("Representing space in the raster model vs. the vector model [8]. Skeeter, CC-BY-SA-4.0.")
...
fig_cap <- paste0("I think this one is pretty good, I use it in my lecture notes[8]. Skeeter, CC-BY-SA-4.0")
...
```{r 3-vector2, echo=FALSE, out.width = '75%', fig.cap=fig_cap}
