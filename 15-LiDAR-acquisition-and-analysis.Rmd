...
fig_cap <- paste("Concept of LiDAR. A light signal is emitted by the scanner and reflected off the target. Animated figure can be viewed in the web browser version of the textbook. ('Concept of LiDAR', @Cartographer3d2021, CC-BY-SA-4.0).")
...
fig_cap <- paste("An example of a typical LiDAR point cloud containing 3.14 million points at approximately 80 points·m^-2^. The point cloud shows a 200 x 200 meter portion of Pacific Spirit Regional Park in Vancouver, and is part of the [2018 City of Vancouver dataset]Animated figure can be viewed in the web browser version of the textbook. (https://opendata.vancouver.ca/explore/dataset/lidar-2018/). (Du Toit, CC-BY-4.0).")
...
fig_cap <- paste("A cross section of a high density point cloud (A, 80 points·m^-2^), and a lower density point cloud (B, 1 point·m^-2^). Animated figure can be viewed in the web browser version of the textbook. (Du Toit, CC-BY-4.0).")
...
fig_cap <- paste("Two examples of how beam divergence affects footprint size. Animated figure can be viewed in the web browser version of the textbook. (Du Toit, CC-BY-4.0).")
...
fig_cap <- paste("Scan angle is the angle from nadir at which the laser is pointing. The scan angle and aircraft flight height together are responsible for swath width.Animated figure can be viewed in the web browser version of the textbook. (Du Toit, CC-BY-4.0).")
...
fig_cap <- paste("An example of a LiDAR Unit. ('LiDAR machine', @TheCenterforInternationalForestryResearchCIFOR2014, Animated figure can be viewed in the web browser version of the textbook. CC-BY-NC-ND-2.0).")
knitr::include_graphics(here::here("images", "15-LiDAR-Unit.png"))
```
...
fig_cap <- paste("An on board GNSS is required toprovide an accurate location of the LiDAR scanner in space. ('A key component of a lidar system is a GPS', @NEONEducation2014, Animated figure can be viewed in the web browser version of the textbook. CC-BY-NC-SA-2.0).")
knitr::include_graphics(here::here("images", "15-XYZ-coordinates.png"))
```
...
fig_cap <- paste("Drone mounted LiDAR. This technology is rapidly developing, with many companies working towards creating units capable of acquiring high density datasets over large areas. Animated figure can be viewed in the web browser version of the textbook. ('LiDARUSA Snoopy 120 LiDAR', @Clapurhands2019,  CC-BY-SA-4.0).")
knitr::include_graphics(here::here("images", "15-LiDAR-on-Drone-2.png"))
```
...
fig_cap <- paste("LiDAR Platforms 1: A terrestrial laser scanner (TLS). ('Lidar P1270901.png', @Monniaux, CC-BY-SA-3.0). 2: A hand-held moblie laser scanner (MLS). (Du Toit, CC-BY-4.0). 3: Car mounted MLS. ('3D mobile mapping unit', @OregonDepartmentofTransportation2016, CC-BY-2.0)'. 4: GEDI, a spaceborne LiDAR sensor. Animated figure can be viewed in the web browser version of the textbook. ('A New Hope: GEDI to Yield 3D Forest Carbon Map', @NEONEducation2014, CC-BY-2.0).")
...
fig_cap <- paste("Differents in the response between discrete echo and full waveform LiDAR. 'Airborne Laser Scanning Discrete Echo and Full Waveform signal comparison', @Beck2012, Animated figure can be viewed in the web browser version of the textbook. CC-BY-SA-3.0).")
...
fig_cap <- paste("A digital elevation model (DEM) produced from LiDAR. Animated figure can be viewed in the web browser version of the textbook. (Du Toit, CC-BY-4.0).")
...
fig_cap <- paste("A canopy height model (CHM), also known as a digital surface model (DSM) produced from LiDAR. Animated figure can be viewed in the web browser version of the textbook. (Du Toit, CC-BY-4.0).")
...
fig_cap <- paste("A typical LiDAR processing workflow. After acquiring data, pre-processing is necessary to clean and normalize the point cloud. After this a CHM can be created to detect tree tops, before segmentating the point cloud based on these points. Animated figure can be viewed in the web browser version of the textbook. (Du Toit, CC-BY-4.0)." )
...
fig_cap <- paste("Example of tree tops detected using the `find_trees` function. (Du Toit, Animated figure can be viewed in the web browser version of the textbook. CC-BY-4.0)." )
...
fig_cap <- paste("Example of multipath errors that can occur. The green dot is where our point is actually located in space, while the blue point shows where the point is placed in the point cloud. The red line shows the path of the reflected pulse. Animated figure can be viewed in the web browser version of the textbook. (Du Toit, CC-BY-4.0)." )
...
fig_cap <- paste("A normalized point cloud. Animated figure can be viewed in the web browser version of the textbook. (Du Toit, CC-BY-4.0)." )
...
fig_cap <- paste("A segmented point cloud using the algorithm based on @Dalponte2016. Animated figure can be viewed in the web browser version of the textbook. (Du Toit, CC-BY-4.0).")
...
fig_cap <- paste("Explore different area-based metrics produced in the case study above. Hover over tile icon (top left) to turn different layers on or off. Animated figure can be viewed in the web browser version of the textbook. Data from City of Vancouver and licensed under the Open Government License - Vancouver (Du Toit, CC-BY-4.0). NOTE: this map contains interactive content and is available online.")
