...
Some key considerations that influence which model is suited for which situations.
...
Each cell in a raster can only have **one** value.  So how do you handle when the area a cell covers contains **multiple** examples.  Possible approaches are: 
