...
(ref:8-vancouver-transit-graph-caption1) Graph representing connection between Metro Vancouver rapid and frequent transit lines. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-directed-graph-caption1) Example of directed graph for social relationships. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-vancouver-rail-transit-caption1) Rail transit line in Vancouver. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-stanley-park-seawall-caption1) Ring of the Stanley Park seawall. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-tree-canopy-mesh-caption1) Tree canopy mesh. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-origin-destination-caption1) Possible origin-destination commutes between municipalities within Metro Vancouver. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-spatial-structure-garden-caption1) Spatial structure of a concentric garden at UBC. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-connections-houses-streets-caption1) Connections between houses and streets. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-boat-marina-caption1) Tree spatial structure of a boat marina. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-fraser-river-flows-caption1) Graph representing Fraser River Flows. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-reach-analysis-caption1) Reachable segments within multiple distance radii. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-closeness-centrality-UBC-caption1) Closeness centrality of the street intersections at UBC. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-betweenness-centrality-caption1) Betweenness centrality of street segments at UBC. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
...
(ref:8-closeness-centrality-vancouver-caption1) Closeness centrality of parks and green spaces at the City of Vancouver. Data from [@city_of_vancouver_open_nodate] and licensed under the Open Government License - Vancouver. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/network-analysis.html.
