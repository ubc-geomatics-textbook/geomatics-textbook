...
fig_cap <- paste0("An isoline map representing growing seasons from the _Atlas of Canada_. Isolines are lines which connect points with identical values.  ('Growing Seasons', [@nicholson_growing_1950], CC BY-NC-SA 3.1) retrieved from [David Rumsey Map Collection](https://www.davidrumsey.com/luna/servlet/s/c68r55).")
...
fig_cap <- paste0("A effective illustration of a cartogram representing the population (%) with no access to clean drinking water. ([@worldmapper_no_2015], CC BY-NC-SA 4.0).")
...
fig_cap <- paste0("The components of effective map composition. ('Map composition.', @manson_composition_2017, CC BY-NC-SA 4.0)")
...
fig_cap <- paste0("Typography standards for cartography. ('Cartographic style guide.', @gaba_cartographic_2014, CC BY 2.5).")
...
fig_cap <- paste0("Six maps of Ottowa at different scales from the _Atlas of Canada_. ('Comparison of scales', @nicholson_comparison_1958, CC BY-NC-SA 3.1).")
...
fig_cap <- paste0("The components of symbolization. ('Symbolization', @manson_symbolization_2013, CC BY-NC-SA 4.0).")
...
fig_cap <- paste0("Separable and integral visual combinations delineated by value/shape and heighth/width, respectively. (@elmer_symbol_2012)")
...
fig_cap <- paste0("Graduated symbols vary symbol size representing a category of values. ('Proportional & Graduated Symbols', @robinson_layout_2020, CC BY-NC-SA 4.1).")
...
fig_cap <- paste0("Proportional symbols vary size of symbols in relation to their attribute value. ('Proportional & Graduated Symbols', @robinson_layout_2020, CC BY-NC-SA 4.1.)")
...
fig_cap <- paste0("Varying the thickness of different lines in the map can help focus attention and differentiate between map features. ('Map Elements and Design Principles', @ingram_map_2021, CC-BY-SA-4.0).")
...
fig_cap <- paste0("Hues are what we commonly think of as the names of colours and distinguish between qualitative data. ('Hue', @manson_hue_2013, CC BY-NC-SA 3.0).")
...
fig_cap <- paste0("Higher values represent lighter colorus while lower values refer to dark colours. ('Chroma', @anderson_chroma_2020, CC BY-NC-SA 4.0).")
...
fig_cap <- paste0("Higher values represent lighter colours while lower values refer to darker colours. ('Value', @manson_value_2013, CC BY-NC-SA 4.0).")
...
fig_cap <- paste0("Different examples of bivariate legends. ('Bivariate', @axis_maps_bivariate_2020, CC BY-NC-SA 4.0).")
