...
<p id="box-text">
Remember, in spatial scale, “small” means a big picture. If you want a refresher on how to read and understand map scales, check out section 2.5 in [Chapter 2](./mapping-data.html).
</p>
...
(ref:12-focus-example-humaneye-caption1) Focusing lens [@vorenkamp_how_2015]. Copyright Todd Vorenkamp. Used with permission. Animated figure can be viewed in the web browser version of the textbook: https://www.opengeomatics.ca/remote-sensing-systems.html#fig:12-focus-example-humaneye.

(ref:12-focus-example-humaneye-caption2) Focusing lens [@vorenkamp_how_2015]. Copyright Todd Vorenkamp. Used with permission.

```{r 12-focus-example-humaneye, fig.cap = fig_cap, out.width="90%", echo = FALSE}
if (knitr:::is_latex_output()) { fig_cap = "(ref:12-focus-example-humaneye-caption1)"
  knitr::include_graphics("images/12-focus_example_humaneye.png")
} else { fig_cap = "(ref:12-focus-example-humaneye-caption2)"
...
(ref:12-RoC-convex-caption) Measuring the radius of curvature for a convex optical surface. Claire Armour, CC BY 4.0.

```{r 12-RoC-convex, fig.cap = fig_cap, out.width="90%", echo = FALSE}
fig_cap = "(ref:12-RoC-convex-caption)"
knitr::include_graphics("images/12-ROC_convex.png")
```
<br/>

(ref:12-RoC-concave-caption) Measuring the radius of curvature for a concave optical surface. Claire Armour, CC BY 4.0.

```{r 12-RoC-concave, fig.cap = fig_cap, out.width="90%", echo = FALSE}
fig_cap = "(ref:12-RoC-concave-caption)"
...
(ref:12-assiniboine-day-caption) Mt Assiniboine, image one [@maguire_mt_nodate], CC BY 4.0.)
...
(ref:12-assiniboine-sunset-caption) Mt Assiniboine, image two [@maguire_mt_nodate-1], CC BY 4.0.
...
(ref:12-push-broom-caption1) Visualization of how a push broom scanner captures imagery. The dark purple squares represent the subset of the area seen by the scanner at any given time and the lighter purple squares show previously scanned areas. Armour, CC-BY-SA-4.0. Animated figure can be viewed in the web browser version of the textbook: https://www.opengeomatics.ca/remote-sensing-systems.html#fig:12-push-broom.

(ref:12-push-broom-caption2) Visualization of how a push broom scanner captures imagery. The dark purple squares represent the subset of the area seen by the scanner at any given time and the lighter purple squares show previously scanned areas. Armour, CC-BY-SA-4.0.

```{r 12-push-broom, fig.cap = fig_cap, out.width="90%", echo = FALSE}
if (knitr:::is_latex_output()) { fig_cap = "(ref:12-push-broom-caption1)"
  knitr::include_graphics("images/12-push-broom.png")
} else { fig_cap = "(ref:12-push-broom-caption2)"
...
(ref:12-swath-width-caption) Swath width. Pickell, CC-BY-SA-4.0.

```{r 12-swath-width, fig.cap = fig_cap, out.width="100%", echo = FALSE}
fig_cap = "(ref:12-swath-width-caption)"
...
(ref:12-scan-angle-caption) Scan angle. Pickell, CC-BY-SA-4.0.

```{r 12-scan-angle, fig.cap = fig_cap, out.width="75%", echo = FALSE}
fig_cap = "(ref:12-scan-angle-caption)"
knitr::include_graphics(here::here("images", "12-scan-angle.png"))
```
<br/>

(ref:12-cross-track-along-track-caption) Pixel dimensions shown as a function of cross-track and along-track travel of the remote sensing platform. Pickell, CC-BY-SA-4.0.

```{r 12-cross-track-along-track, fig.cap = fig_cap, out.width="75%", echo = FALSE}
fig_cap = "(ref:12-cross-track-along-track-caption)"
...
(ref:12-aerial-plane-caption) Aerial photo of forest, road, and river near Kitimat, BC [@den_engelsen_photo_2020]. [Unsplash License](https://unsplash.com/license).
...
(ref:12-aerial-good-caption1) How aerial imagery should be taken. Claire Armour. CC-BY-SA-4.0. Animated figure can be viewed in the web browser version of the textbook: https://www.opengeomatics.ca/remote-sensing-systems.html#fig:12-aerial-good.

(ref:12-aerial-good-caption2) How aerial imagery should be taken. Claire Armour. CC-BY-SA-4.0.

```{r 12-aerial-good, fig.cap = fig_cap, out.width="90%", echo = FALSE}
if (knitr:::is_latex_output()) { fig_cap = "(ref:12-aerial-good-caption1)"
  knitr::include_graphics("images/12-aerial-good.png")
} else { fig_cap = "(ref:12-aerial-good-caption2)"
  knitr::include_graphics("images/12-aerial-good.gif")
}
```

(ref:12-aerial-bad-caption1) How aerial imagery should NOT be taken. Claire Armour, CC-BY-SA-4.0. Animated figure can be viewed in the web browser version of the textbook: https://www.opengeomatics.ca/remote-sensing-systems.html#fig:12-aerial-bad.

(ref:12-aerial-bad-caption2) How aerial imagery should NOT be taken. Claire Armour, CC-BY-SA-4.0.

```{r 12-aerial-bad, fig.cap = fig_cap, out.width="90%", echo = FALSE}
if (knitr:::is_latex_output()) { fig_cap = "(ref:12-aerial-bad-caption1)"
  knitr::include_graphics("images/12-aerial-bad.png")
} else { fig_cap = "(ref:12-aerial-bad-caption2)"
...
(ref:12-zenith-image-caption) Zenith perspective taken from the ground looking up to the canopy of an old growth tree on Vancouver Island, British Columbia. Pickell, CC-BY-SA-4.0.

```{r 12-zenith-image, fig.cap = fig_cap, out.width="90%", echo = FALSE}
fig_cap = "(ref:12-zenith-image-caption)"
...
(ref:12-oblique-image-caption) Oblique image of a forest harvest near Cold Lake in Saskatchewan. Ignacio San-Miguel, CC-BY-SA-4.0.

```{r 12-oblique-image, fig.cap = fig_cap, out.width="90%", echo = FALSE}
fig_cap = "(ref:12-oblique-image-caption)"
...
(ref:12-hemisphere-view-caption) Visualization of a hemispherical perspective. Claire Armour, CC BY 4.0.

```{r 12-hemisphere-view, fig.cap = fig_cap, out.width="90%", echo = FALSE}
fig_cap = "(ref:12-hemisphere-view-caption)"
...
(ref:12-hemispherical-lens-caption) Hemispherical photo taken in the Bavarian forest [@wegmann_hemispherical_2011], CC BY 3.0 Unported.
...
(ref:12-newfoundland-from-space-caption) Picture of Newfoundland, Canada, taken by David Saint-Jacques during his space mission [@canadian_space_agency_newfoundland_2019], CC BY 3.0 Unported.
...
(ref:12-platforms-caption) Different types of platforms for remote sensing systems. Image scale is represented on the y-axis in log scale. Pickell, CC-BY-SA-4.0.

```{r 12-platforms, fig.cap = fig_cap, out.width="90%", echo = FALSE}
fig_cap = "(ref:12-platforms-caption)"
...
(ref:12-phenological-camera-sequence-caption1) Time lapse from a camera mounted on a tree. Each image is taken on a different day at noon [@bater_timelapse_nodate]. CC-BY-SA-4.0. Animated figure can be viewed in the web browser version of the textbook: https://www.opengeomatics.ca/remote-sensing-systems.html#fig:12-phenological-camera-sequence.

(ref:12-phenological-camera-sequence-caption2) Time lapse from a camera mounted on a tree. Each image is taken on a different day at noon [@bater_timelapse_nodate]. CC-BY-SA-4.0.

```{r 12-phenological-camera-sequence, fig.cap = fig_cap, out.width="90%", echo = FALSE}
if (knitr:::is_latex_output()) { fig_cap = "(ref:12-phenological-camera-sequence-caption1)"
  knitr::include_graphics("images/12-phenological-camera-sequence.png")
} else { fig_cap = "(ref:12-phenological-camera-sequence-caption2)"
...
(ref:12-mountain-legacy-project-caption1) Image pair of Athabasca Glacier from Wilcox Pass in Jasper National Park, Alberta, Canada. The historical image was taken in 1917 by A.O. Wheeler [@library_and_archives_canada_athabasca_1917], and the modern image was taken nearly a hundred years later in 2011 by the Mountain Legacy Project [@mountain_legacy_project_modern_2011]. CC-BY-SA-4.0. Animated figure can be viewed in the web browser version of the textbook: https://www.opengeomatics.ca/remote-sensing-systems.html#fig:12-mountain-legacy-project.

(ref:12-mountain-legacy-project-caption2) Image pair of Athabasca Glacier from Wilcox Pass in Jasper National Park, Alberta, Canada. The historical image was taken in 1917 by A.O. Wheeler [@library_and_archives_canada_athabasca_1917], and the modern image was taken nearly a hundred years later in 2011 by the Mountain Legacy Project [@mountain_legacy_project_modern_2011]. CC-BY-SA-4.0.

```{r 12-mountain-legacy-project, fig.cap = fig_cap, out.width="90%", echo = FALSE}
if (knitr:::is_latex_output()) { fig_cap = "(ref:12-mountain-legacy-project-caption1)"
  knitr::include_graphics("images/12-mountain-legacy-project.png")
} else { fig_cap = "(ref:12-mountain-legacy-project-caption2)"
...
(ref:12-sunsynchronous-geosynchronous-orbits-caption1) Comparing Sun-synchronous and geosynchronous orbits. The yellow area shows the portion of Earth's surface that is visible during a single orbit. Notice that Sun-synchronous orbit observes at a consistent local time while the geosynchronous orbit observes a constant location. Credit: [NOAA/JPL-Caltech](https://scijinks.gov/about/). Animated figure can be viewed in the web browser version of the textbook: https://www.opengeomatics.ca/remote-sensing-systems.html#fig:12-sunsynchronous-geosynchronous-orbits.

(ref:12-sunsynchronous-geosynchronous-orbits-caption2) Comparing Sun-synchronous and geosynchronous orbits. The yellow area shows the portion of Earth's surface that is visible during a single orbit. Notice that Sun-synchronous orbit observes at a consistent local time while the geosynchronous orbit observes a constant location. Credit: [NOAA/JPL-Caltech](https://scijinks.gov/about/).

```{r 12-sunsynchronous-geosynchronous-orbits, fig.cap = fig_cap, out.width="75%", echo = FALSE}
if (knitr:::is_latex_output()) { fig_cap = "(ref:12-sunsynchronous-geosynchronous-orbits-caption1)"
  knitr::include_graphics("images/12-sunsynchronous-geosynchronous-orbits.png")
} else { fig_cap = "(ref:12-sunsynchronous-geosynchronous-orbits-caption2)"
