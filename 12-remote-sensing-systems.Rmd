...
fig_cap <- paste("North and South America as seen from the NASA GOES-1 satellite. Captured from KeepTrack.space via NASA. Animated figure can be viewed in the web browser version of the textbook. [Copyright (C) 2007 Free Software Foundation, Inc.](https://fsf.org/)")
...
fig_cap <- paste("Selected material from [How Focus Works](https://www.bhphotovideo.com/explora/photography/tips-and-solutions/how-focus-works). Animated figure can be viewed in the web browser version of the textbook. Copyright Todd Vorenkamp. Used with permission.)")
...
fig_cap <- paste("Measuring the radius of curvature for a convex optical surface. Claire Armour. Animated figure can be viewed in the web browser version of the textbook. [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)")
...
fig_cap <- paste("Measuring the radius of curvature for a concave optical surface. Claire Armour. Animated figure can be viewed in the web browser version of the textbook. [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)")
...
fig_cap <- paste("[Aerial photo of forest, road, and river near Kitimat, BC](https://unsplash.com/photos/UFwW97AP0LI). [Ben den Engelsen](https://unsplash.com/@benjeeeman) on Unsplash.Animated figure can be viewed in the web browser version of the textbook. [Unsplash License](https://unsplash.com/license)")
...
fig_cap <- paste("How aerial imagery should be taken. Claire Armour. Animated figure can be viewed in the web browser version of the textbook. [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)")
...
fig_cap <- paste("How aerial imagery should NOT be taken. Claire Armour. Animated figure can be viewed in the web browser version of the textbook. [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)")
...
fig_cap <- paste("[Looking towards the sky through the trees in a forest in Sweden](https://unsplash.com/photos/Mg1xk9i0yEU). [Joachim Bohlander](https://unsplash.com/@joacimbohlander) on Unsplash. Animated figure can be viewed in the web browser version of the textbook. [Unsplash License](https://unsplash.com/license)")
...
fig_cap <- paste("[Oblique image of mountainside trees in Lake Louise, Alberta, Canada](https://unsplash.com/photos/P36KI_ws3vs). Animated figure can be viewed in the web browser version of the textbook. [Vlad Shapochnikov](https://unsplash.com/@vladshap) on Unsplash. [Unsplash License](https://unsplash.com/license)")
...
fig_cap <- paste("Visualization of a hemispherical perspective. Animated figure can be viewed in the web browser version of the textbook. Claire Armour. [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)")
...
fig_cap <- paste("[Hemispherical photo taken in the Bavarian forest](https://en.wikipedia.org/wiki/File:Hemispherical_photo1.png). [Martin Wegmann](https://commons.wikimedia.org/wiki/User:Wegmann). Animated figure can be viewed in the web browser version of the textbook. [CC BY 3.0 Unported](https://creativecommons.org/licenses/by/3.0/)")
...
fig_cap <- paste("[Picture of Newfoundland, Canada, taken by David Saint-Jacques during his space mission.] Animated figure can be viewed in the web browser version of the textbook. (https://asc-csa.gc.ca/eng/multimedia/search/image/watch/13330). [Canadian Space Agency/NASA](https://asc-csa.gc.ca/eng/terms.asp#copyright). [CC BY 3.0 Unported](https://creativecommons.org/licenses/by/3.0/)")
