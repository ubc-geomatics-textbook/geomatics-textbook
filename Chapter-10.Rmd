...
Spatially mapped objects with information ("attributes") attached to them can be related 
...
::: 
**Attributes**
The information attached to the study objects that are spatially distributed in a Domain. Often are termed as variable of interest. 
