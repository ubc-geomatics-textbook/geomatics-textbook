...
```{r 9-mount-assiniboine-dem, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Digital Elevation Model of Mount Assiniboine at the border of Alberta and British Columbia, Canada. Animated figure can be viewed in the web browser version of the textbook. Data from Canadian Digital Elevation Model. Pickell, CC-BY-4.0.")
...
<<<<<<< HEAD
    fig_cap <- paste("Digital Elevation Model of Nelson River pouring into Hudson Bay, Manitoba, Canada. Data from Shuttle Radar Topography Mission. Pickell, CC-BY-SA-4.0.")
=======
    fig_cap <- paste("Digital Elevation Model of Nelson River pouring into Hudson Bay, Manitoba, Canada. Animated figure can be viewed in the web browser version of the textbook. Data from Shuttle Radar Topography Mission. Pickell, CC-BY-4.0.")
>>>>>>> 7069a7d0857d1af2274e09f7a43498096f7166a1
...
```{r 9-mount-assiniboine-slope, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Slope of Mount Assiniboine at the border of Alberta and British Columbia, Canada. Animated figure can be viewed in the web browser version of the textbook. Data from Canadian Digital Elevation Model. Pickell, CC-BY-SA-4.0.")
...
```{r 9-nelson-river-slope, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Slope of Nelson River pouring into Hudson Bay, Manitoba, Canada. Animated figure can be viewed in the web browser version of the textbook. Data from Shuttle Radar Topography Mission. Pickell, CC-BY-SA-4.0.")
...
```{r 9-mount-assiniboine-aspect, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Aspect of Mount Assiniboine at the border of Alberta and British Columbia, Canada.Animated figure can be viewed in the web browser version of the textbook. Data from Canadian Digital Elevation Model. Pickell, CC-BY-SA-4.0.")
...
```{r 9-nelson-river-aspect, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Aspect of Nelson River pouring into Hudson Bay, Manitoba, Canada. Data from Shuttle Radar Topography Mission.Animated figure can be viewed in the web browser version of the textbook. Pickell, CC-BY-SA-4.0.")
...
```{r 9-peak, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("A peak is shown in 3D for an array of 3x3 pixels. Animated figure can be viewed in the web browser version of the textbook. Pickell, CC-BY-SA-4.0.")
...
```{r 9-saddle, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("A saddle is shown in 3D for an array of 3x3 pixels. Animated figure can be viewed in the web browser version of the textbook. Pickell, CC-BY-SA-4.0.")
...
```{r 9-stacked-profile-planform, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Conceptual diagram showing surfaces of all combinations of profile and planform curvature. Animated figure can be viewed in the web browser version of the textbook. Pickell, CC-BY-SA-4.0.")
...
```{r 9-stacked-profile-planform-kernel, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Conceptual diagram showing 3x3 kernel examples of all combinations of profile and planform curvature. Animated figure can be viewed in the web browser version of the textbook. Pickell, CC-BY-SA-4.0.")
...
```{r 9-mount-assiniboine-profile-planform-curvature, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Profile and planform curvature for Mount Assiniboine at the border of Alberta and British Columbia, Canada. Animated figure can be viewed in the web browser version of the textbook. Data from Canadian Digital Elevation Model. Pickell, CC-BY-SA-4.0.")
...
```{r 9-mount-assiniboine-nelson-river-topographic-position-index, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Comparing Topographic Position Index (TPI) for Mount Assiniboine and the Nelson River. Animated figure can be viewed in the web browser version of the textbook. Data from Canadian Digital Elevation Model and MAXAR, respectively. Pickell, CC-BY-SA-4.0.")
...
```{r 9-flow-direction-accumulation, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Flow direction shown in arrows and flow accumulation of upslope cells shown in numbers for the D8 flow direction algorithm. Animated figure can be viewed in the web browser version of the textbook. Pickell, CC-BY-SA-4.0.")
...
```{r 9-mount-assiniboine-flow-dir-acc, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("D8 Flow direction and flow accumulation for Mount Assiniboine at the border of Alberta and British Columbia, Canada. Data from Canadian Digital Elevation Model. Animated figure can be viewed in the web browser version of the textbook. Pickell, CC-BY-SA-4.0.")
...
fig_cap <- "The Fort St. John Timber Supply Area, British Columbia, Canada. Data from Government of British Columbia and licensed under the Open Government Licence - British Columbia. Animated figure can be viewed in the web browser version of the textbook. Mesler, CC-BY-SA-4.0."
m
```
...
```{r 9-SAGA-Wetness, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("System for Automated Geoscientific Analyses (SAGA) Wetness Index across the Chowade Watershed. Animated figure can be viewed in the web browser version of the textbook. Melser, CC-BY-SA-4.0.")
...
fig_cap <- paste("Multi-Resolution Valley Bottom Flatness (MRVBF) Computational Components described by Gallant and Dowling 2003. Melser, CC-BY-SA-4.0.")
...
fig_cap <- paste("Multi-resolution Valley Bottom Flatness (MRVBF) across the Chowade Watershed. Animated figure can be viewed in the web browser version of the textbook. Melser, CC-BY-SA-4.0.")
...
<<<<<<< HEAD
fig_cap <- paste("Input layers and output prediction raster for the Chowade Watershed Management basin. Animated figure can be viewed in the web browser version of the textbook.Data from City of Vancouver and licensed under the Open Government License - Vancouver. Melser, CC-BY-SA-4.0.")
=======
fig_cap <- paste("Input layers and output prediction raster for the Chowade Watershed Management basin. Animated figure can be viewed in the web browser version of the textbook. Melser, CC-BY-SA-4.0.")
>>>>>>> 7692daad6296050671abede9a15cdedf46d63695
m2
```
...
```{r 9-baffin-island-mount-odin-1, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Anaglyph of Mount Odin on Baffin Island, Nunavut, Canada. Imagery by MAXAR. Animated figure can be viewed in the web browser version of the textbook. Pickell, CC-BY-SA-4.0.")
...
```{r 9-vancouver-building-height-extruded, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Animation showing building polygons in Vancouver, British Columbia extruded by a height attribute. Animated figure can be viewed in the web browser version of the textbook. Building data (2009) from City of Vancouver, licensed under Open Government License - Vancouver. Base map © OpenStreetMap contributors, licensed under Open Data Commons Open Database License. Pickell, CC-BY-SA-4.0.")
...
```{r 9-mount-logan-exaggeration, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Elevation exaggeration of Mount Logan elevation, Yukon Terrotiry, Canada. Animated figure can be viewed in the web browser version of the textbook. Digital Elevation Model by Natural Resources Canada, licensed under the Open Government Licence – Canada. Pickell, CC-BY-SA-4.0.")
