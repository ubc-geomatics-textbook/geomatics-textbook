...
if (knitr:::is_latex_output()) { fig_cap <- paste0("Focusing lens [@vorenkamp_how_2015]. Copyright Todd Vorenkamp. Used with permission. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/remote-sensing-systems.html")
  knitr::include_graphics("images/12-focus_example_humaneye.png")
} else { fig_cap <- paste0("Focusing lens [@vorenkamp_how_2015]. Copyright Todd Vorenkamp. Used with permission.")
...
if (knitr:::is_latex_output()) { fig_cap <- paste0("Visualization of how a push broom scanner captures imagery. The dark purple squares represent the subset of the area seen by the scanner at any given time and the lighter purple squares show previously scanned areas. Armour, CC-BY-SA-4.0. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/remote-sensing-systems.html")
  knitr::include_graphics("images/12-push-broom.png")
} else { fig_cap <- paste0("Visualization of how a push broom scanner captures imagery. The dark purple squares represent the subset of the area seen by the scanner at any given time and the lighter purple squares show previously scanned areas. Armour, CC-BY-SA-4.0.")
...
if (knitr:::is_latex_output()) { fig_cap <- paste0("How aerial imagery should be taken. Claire Armour. CC-BY-SA-4.0. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/remote-sensing-systems.html")
  knitr::include_graphics("images/12-aerial-good.png")
} else { fig_cap <- paste0("How aerial imagery should be taken. Claire Armour. CC-BY-SA-4.0.")
  knitr::include_graphics("images/12-aerial-good.gif")
}
```

```{r 12-aerial-bad, fig.cap = fig_cap, out.width="90%", echo = FALSE}
if (knitr:::is_latex_output()) { fig_cap <- paste0("How aerial imagery should NOT be taken. Claire Armour. CC-BY-SA-4.0. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/remote-sensing-systems.html")
...
if (knitr:::is_latex_output()) { fig_cap <- paste0("Time lapse from a camera mounted on a tree. Each image is taken on a different day at noon [@bater_timelapse_nodate]. CC-BY-SA-4.0. Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/remote-sensing-systems.html")
  knitr::include_graphics("images/12-phenological-camera-sequence.png")
} else { fig_cap <- paste0("Time lapse from a camera mounted on a tree. Each image is taken on a different day at noon [@bater_timelapse_nodate]. CC-BY-SA-4.0.")
...
if (knitr:::is_latex_output()) { fig_cap <- paste0("Comparing Sun-synchronous and geosynchronous orbits. The yellow area shows the portion of Earth's surface that is visible during a single orbit. Notice that Sun-synchronous orbit observes at a consistent local time while the geosynchronous orbit observes a constant location. Credit: [NOAA/JPL-Caltech](https://scijinks.gov/about/). Animated figure can be viewed in the web browser version of the textbook: https://ubc-geomatics-textbook.github.io/geomatics-textbook/remote-sensing-systems.html")
  knitr::include_graphics("images/12-sunsynchronous-geosynchronous-orbits.png")
} else { fig_cap <- paste0("Comparing Sun-synchronous and geosynchronous orbits. The yellow area shows the portion of Earth's surface that is visible during a single orbit. Notice that Sun-synchronous orbit observes at a consistent local time while the geosynchronous orbit observes a constant location. Credit: [NOAA/JPL-Caltech](https://scijinks.gov/about/).")
