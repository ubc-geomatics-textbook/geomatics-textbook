...
fig_cap <- paste("Delauney triangulation of the same set of points as in the previous Thiessen polygons figure. Pickell, CC-BY-SA-4.0.")
...
fig_cap <- paste("Thiessen polygons formed  Pickell, CC-BY-SA-4.0.")
...
fig_cap <- paste("Concave alpha hull generates an alpha shape around a set of points. Online version of the figure is animated by alpha values from 0 to 1 by increments of 0.05. Pickell, CC-BY-SA-4.0.")
...
fig_cap <- paste("The five Platonic solids are examples of regular, convex polyhedrons and multipatch geometries. From left to right: tetrahedron (4 faces); hexahedron (6 faces); octahedron (8 faces); dodecahedron (12 faces); and icosahedron (20 faces). Online version of the figure is animated. Kjell André, CC-BY-SA-3.0.")
...
``` {r 7-tin, echo=FALSE, out.width = '75%', fig.cap=fig_cap, webgl = TRUE}
#fig_cap <- paste("3D convex hull. Pickell, CC-BY-SA-4.0.")
#library(mgcv)
#library(rLiDAR)
#las <- lidR::readLAS("data/07/fsc-building.las")
```
...
fig_cap <- paste("3Dalpha-convex hull for the Forest Sciences Centre building at the University of British Columbia. The alpha hull was generated using alpha = 1. Data from City of Vancouver and licensed under the Open Government License - Vancouver. Pickell, CC-BY-SA-4.0.")
...
fig_cap <- paste("3D concave alpha hull for a deciduous tree (species here). The alpha hull was generated using alpha = 0.05. Data collected by Spencer Dakin Kuiper with a GeoSlam terrestrial laser scanner in Vancouver, Canada. Pickell, CC-BY-SA-4.0.")
...
fig_cap <- paste('3D convex alpha hull for a coniferous tree (<i>Abies lasiocarpa</i>). The alpha hull was generated using alpha = 0.1. Data collected by Yangqian "Frederick" Qi with a terrestrial laser scanner in British Columbia, Canada. Pickell, CC-BY-SA-4.0.')
