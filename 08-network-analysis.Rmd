...
forceNetwork(Links = MisLinks, Nodes = MisNodes, Source = "source", Value="value",
             ...
             Group = "group", opacity=0.8, arrow=TRUE)
```
</br>
...
fig_cap <- paste0("Least cost path (in terms of distance) between two points [@city_of_vancouver_open_nodate]. Licensed under the Open Government License - Vancouver. Interactive figure in the online format of the textbook.")
