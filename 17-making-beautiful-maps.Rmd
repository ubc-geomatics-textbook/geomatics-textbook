...
![Maps illustrate how variables are related in space. [@statistics_canada_thematic_2016] (c) [Statistics Canada](https://www-statcan-gc-ca.eu1.proxy.openathens.net/eng/about/about?MM=as), [Open Government Licence - Canada](https://open.canada.ca/en/open-government-licence-canada).](images/17-moncton.png){.center}
...
![One example of a reference map. [@shannon1_longest_2017] (c) [Shannon1](https://en.wikipedia.org/wiki/User:Shannon1), [CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/).](images/17-longRivers.png){.center}
...
![A thematic map using qualitative categorical data. [@nicholson_bedrock_1956] (c) Comtois and Nicholson, [CC BY-NC-SA 3.0](https://creativecommons.org/licenses/by-nc-sa/3.0/).](images/17-geology.png){.center}
...
![A thematic map depicting population data as a percentage. [@statistics_canada_illustrated_2017] (c) [Statistics Canada](https://www-statcan-gc-ca.eu1.proxy.openathens.net/eng/about/about?MM=as), [Open Government License - Canada](https://open.canada.ca/en/open-government-licence-canada).](images/17-population.png){.center}
