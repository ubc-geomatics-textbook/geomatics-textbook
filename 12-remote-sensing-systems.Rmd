...
fig_cap <- paste("[Hemispherical photo taken in the Bavarian forest](https://en.wikipedia.org/wiki/File:Hemispherical_photo1.jpg). [Martin Wegmann](https://commons.wikimedia.org/wiki/User:Wegmann). Animated figure can be viewed in the web browser version of the textbook. [CC BY 3.0 Unported](https://creativecommons.org/licenses/by/3.0/)")
