...
) (c) [Statistics Canada](https://www-statcan-gc-ca.eu1.proxy.openathens.net/eng/about/about?MM=as), [Open Government Licence - Canada](https://open.canada.ca/en/open-government-licence-canada).](images/01-moncton.png){.center}
...
) (c) Comtois and Nicholson, [CC BY-NC-SA 3.0](https://creativecommons.org/licenses/by-nc-sa/3.0/).](images/03-geology.png){.center}
...
) (c) [Statistics Canada](https://www-statcan-gc-ca.eu1.proxy.openathens.net/eng/about/about?MM=as), [Open Government License - Canada](https://open.canada.ca/en/open-government-licence-canada).](images/04-population.png){.center}
...
knitr::include_graphics(here::here("images", "07-isoline.png"))
```

 - 07-isoline.png from row 23 of [OER Content Sharing](https://docs.google.com/spreadsheets/d/1LqzXn00wMeIjHWstNT3tMImNDZirLGc3g72jFOQc_8I/edit#gid=817407192){target="_blank"}
...
knitr::include_graphics(here::here("images", "09-figure.png"))
```
...
knitr::include_graphics(here::here("images", "11-scale.png"))
```
