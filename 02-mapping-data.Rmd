...
```{r 2-Eratosthenes, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Diagram showing how Eratosthenes estimated the circumference of Earth by observing the angle of a shadow that was cast about 800 km north of Syene in present-day Egypt.<a href='",baseurl,"fig:2-Eratosthenes'>Animated figure can be viewed in the web broswer version of the textbook</a>. David Monniaux, CC-BY-SA-4.0.")
...
```{r 2-height, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Diagram for measuring height above a datum. <a href='",baseurl,"#fig:2-height'>Animated figure can be viewed in the web browser version of the textbook</a>. Pickell, CC-BY-SA-4.0.")
...
```{r 2-geodetic-datum, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Spherical geodetic datum. <a href='",baseurl,"#fig:2-geodetic-datum'>Animated figure can be viewed in the web browser version of the textbook</a>. Pickell, CC-BY-SA-4.0.")
...
```{r 2-tidal-datum, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Conceptual tidal datum for Canada.<a href='",baseurl,"#fig:2-tidal-datum'>Animated figure can be viewed in the web browser version of the textbook</a>. Pickell, CC-BY-SA-4.0.")
...
```{r 2-H-h-N, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Orthometric Height (H) is the ellipsoidal height (h) less the geoid height (N).<a href='",baseurl,"#fig:2-H-h-N'>Animated figure can be viewed in the web browser version of the textbook</a>. Pickell, CC-BY-SA-4.0.")
...
```{r 2-geoid-tunnel, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Thought experiment showing where water would be at rest within a tunnel through the geoid due to the equipotential force of gravity (g).<a href='",baseurl,"#fig:2-geoid-tunnel'>Animated figure can be viewed in the web browser version of the textbook</a>. Pickell, CC-BY-SA-4.0.")
...
href='",baseurl,"#fig:2-CGVD-leaflet'>Animated figure can be viewed in the web browser version of the textbook</a>.Data from Natural Resources Canada and licensed under the <a href='",covlicence,">Open Government Licence - Canada </a>.Pickell, CC-BY-SA-4.0.")  
...
```{r 2-geocentric-geodetic-latitude, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Geocentric versus geodetic latitude. <a href='",baseurl,"#fig:2-geocentric-geodetic-latitude'>Animated figure can be viewed in the web browser version of the textbook</a>. Pickell, CC-BY-SA-4.0.")
...
```{r 2-reference-indicatrix, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Reference Tissot Indicatrix.<a href='",baseurl,"#fig:2-reference-indicatrix'>Animated figure can be viewed in the web browser version of the textbook</a>. Pickell, CC-BY-SA-4.0.")
...
```{r 2-reference-equivalent, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Equivalent Tissot Indicatrix.<a href='",baseurl,"#fig:2-reference-equivalent'>Animated figure can be viewed in the web browser version of the textbook </a>. Pickell, CC-BY-SA-4.0.")
...
```{r 2-conformal-indicatrix, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Conformal Tissot Indicatrix.<a href='",baseurl,"#fig:2-conformal-indicatrix'>Animated figure can be viewed in the web browser version of the textbook </a>. Pickell, CC-BY-SA-4.0.")
...
```{r 2-Mercator-map, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Mercator map projection with Tissot's Indicatrices in red.<a href='",baseurl,"#fig:2-Mercator-map'>Animated figure can be viewed in the web browser version of the textbook </a>. Pickell, CC-BY-SA-4.0.")
...
```{r 2-UTM-13N-map, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Universal Transverse Mercator Zone 13 map projection with Tissot's Indicatrices in red.<a href='",baseurl,"#fig:2-UTM-13N-map'>Animated figure can be viewed in the web browser version of the textbook </a>. Pickell, CC-BY-SA-4.0.")
...
```{r 2-Sinusoidal-map, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("Sinusoidal map projection with Tissot's Indicatrices in red. <a href='",baseurl,"#fig:2-Sinusoidal-map'>Animated figure can be viewed in the web browser version of the textbook </a>. Pickell, CC-BY-SA-4.0.")
...
```{r 2-BC-Albers-map, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste("British Columbia Environment Albers map projection with Tissot's Indicatrices in red. <a href='",baseurl,"#fig:2-BC-Albers-map'>Animated figure can be viewed in the web browser version of the textbook </a> Pickell, CC-BY-SA-4.0.")
