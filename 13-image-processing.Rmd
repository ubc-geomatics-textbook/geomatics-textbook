...
```{r 13-cubic, fig.cap = fig_cap, out.width = "75%", out.height="75%", echo = FALSE}
    fig_cap <- paste("Demonstration of neighbour selection (red) using cubic convolution resampling to determine the value of a single cell (yellow) in an empty raster. Animated figure can be viewed in the web browser version of the textbook. (Hacker, CC-BY-4.0")
...
```{r 13-landsat-c2-l2, fig.cap = fig_cap, out.width="90%", echo = FALSE}
    fig_cap <- paste("Three unique Landsat 8 Collection 2 images. In order from left to right: Level-1 Top of Atmosphere reflectance image (no atmospheric correction), Level-2 atmospherically corrected surface reflectance and Level-2 surface temperature. Images were collected on May 3, 2013 over the Sapta Kosh River in Bairawa, Nepal. Animated figure can be viewed in the web browser version of the textbook. Created by Michelle A. Bouchard, USGS. Public domain.")
