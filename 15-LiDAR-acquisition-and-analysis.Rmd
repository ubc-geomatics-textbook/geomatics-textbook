...
fig_cap <- paste("Explore different area-based metrics produced in the case study above. Hover over tile icon (top left) to turn different layers on or off. Animated figure can be viewed in the web browser version of the textbook. (Du Toit, CC-BY-4.0). NOTE: this map contains interactive content and is available online.")
