...
```{r 2-Eratosthenes, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Diagram showing how Eratosthenes estimated the circumference of Earth by observing the angle of a shadow that was cast about 800 km north of Syene in present-day Egypt. David Monniaux, CC-BY-SA-4.0.")
