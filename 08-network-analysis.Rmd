...
fig_cap <- paste0("Graph representing connection between Metro Vancouver rapid and frequent transit lines. <a href='",baseurl,"#fig:8-vancouver-transit-graph'>Animated figure can be viewed in the web browser version of the textbook</a>.")
data <- data.frame(
...
fig_cap <- paste0("Example of directed graph for social relationships. <a href='",baseurl,"#fig:8-directed-graph'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Rail transit line in Vancouver. Data from [@city_of_vancouver_open_nodate] and licensed under the <a href='",covlicence,"'>Open Government License - Vancouver</a>. <a href='",baseurl,"#fig: 8-vancouver-rail-transit'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Ring of the Stanley Park seawall. Data from [@city_of_vancouver_open_nodate] and licensed under the <a href='",covlicence,"'>Open Government License - Vancouver</a>. <a href='",baseurl,"#fig:8-stanley-park-seawall'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Tree canopy mesh. Data from [@city_of_vancouver_open_nodate] and licensed under the <a href='",covlicence,"'>Open Government License - Vancouver</a>. <a href='",baseurl,"#fig:8-tree-canopy-mesh'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Possible origin-destination commutes between municipalities within Metro Vancouver. Data from [@city_of_vancouver_open_nodate] and licensed under the
 <a href='",covlicence,"'>Open Government License - Vancouver</a>. <a href='",baseurl,"#fig:8-origin-destination'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Spatial structure of a concentric garden at UBC. Data from [@city_of_vancouver_open_nodate] and licensed under the
 <a href='",covlicence,"'>Open Government License - Vancouver</a>. <a href='",baseurl,"#fig:8-spatial-structure-garden'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Connections between houses and streets. Data from [@city_of_vancouver_open_nodate] and licensed under the 
 <a href='",covlicence,"'>Open Government License - Vancouver</a>. <a href='",baseurl,"#fig:8-connections-houses-streets'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Tree spatial structure of a boat marina. Data from [@city_of_vancouver_open_nodate] and licensed under the 
 <a href='",covlicence,"'>Open Government License - Vancouver</a> .<a href='",baseurl,"#fig:8-boat-marina'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Graph representing Fraser River Flows. Data from [@city_of_vancouver_open_nodate] and licensed under the 
 <a href='",covlicence,"'>Open Government License - Vancouver</a>. <a href='",baseurl,"#fig:8-fraser-river-flows'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Least cost path (in terms of distance) between two points. Data from [@city_of_vancouver_open_nodate] and licensed under the 
 <a href='",covlicence,"'>Open Government License - Vancouver</a>. <a href='",baseurl,"#fig:8-least-cost-path'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Reachable segments within multiple distance radii. Data from [@city_of_vancouver_open_nodate] and licensed under the 
 <a href='",covlicence,"'>Open Government License - Vancouver</a>. <a href='",baseurl,"#fig:8-reach-analysis'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Closeness centrality of the street intersections at UBC. Data from [@city_of_vancouver_open_nodate] and licensed under the 
 <a href='",covlicence,"'>Open Government License - Vancouver</a>.<a href='",baseurl,"#fig:8-closeness-centrality-UBC'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Betweenness centrality of street segments at UBC. Data from [@city_of_vancouver_open_nodate] and licensed under the 
 <a href='",covlicence,"'>Open Government License - Vancouver</a>. <a href='",baseurl,"#fig:8-betweenness-centrality'>Animated figure can be viewed in the web browser version of the textbook</a>.")
...
fig_cap <- paste0("Closeness centrality of parks and green spaces at the City of Vancouver. Data from [@city_of_vancouver_open_nodate]and licensed under the <a href='",covlicence,"'>Open Government License - Vancouver</a>.<a href='",baseurl,"#fig:8-closeness-centrality-vancouver'>Animated figure can be viewed in the web browser version of the textbook</a>.")
