...
2. Identify the segments of a GNSS
3. Synthesize the sources of error to GNSS position
...
#### Clock Errors $c(dt-dT)$ {.unnumbered}
...
#### Ionospheric Delays $I_f$ {.unnumbered}
...
#### Tropospheric Delays $T$ {.unnumbered}
...
#### Instrument Noise $ε_S$ and $ε_R$ {.unnumbered}
...
1. What are the three segments of a GNSS?
...
3. What are the differences between the almanac and ephemeris data?
4. What are some ways that you can plan your GNSS data acquisition to minimize errors?
