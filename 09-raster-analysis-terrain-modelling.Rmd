...
```{r 9-mount-assiniboine-dem, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Digital Elevation Model of Mount Assiniboine at the border of Alberta and British Columbia, Canada. Data from Canadian Digital Elevation Model. Pickell, CC-BY-4.0.")
...
```{r 9-nelson-river-dem, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Digital Elevation Model of Nelson River pouring into Hudson Bay, Manitoba, Canada. Data from Shuttle Radar Topography Mission. Pickell, CC-BY-4.0.")
...
```{r 9-mount-assiniboine-slope, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Slope of Mount Assiniboine at the border of Alberta and British Columbia, Canada. Data from Canadian Digital Elevation Model. Pickell, CC-BY-SA-4.0.")
...
```{r 9-nelson-river-slope, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Slope of Nelson River pouring into Hudson Bay, Manitoba, Canada. Data from Shuttle Radar Topography Mission. Pickell, CC-BY-SA-4.0.")
...
```{r 9-mount-assiniboine-aspect, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Aspect of Mount Assiniboine at the border of Alberta and British Columbia, Canada. Data from Canadian Digital Elevation Model. Pickell, CC-BY-SA-4.0.")
...
```{r 9-nelson-river-aspect, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Aspect of Nelson River pouring into Hudson Bay, Manitoba, Canada. Data from Shuttle Radar Topography Mission. Pickell, CC-BY-SA-4.0.")
...
```{r 9-mount-assiniboine-hillshade-animation, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Hillshade of Mount Assiniboine at the border of Alberta and British Columbia, Canada.<a href='",baseurl,"#fig:9-mount-assiniboine-hillshade-animation'>Animated figure can be viewed in the web browser version of the textbook</a> Data from Canadian Digital Elevation Model. Online version is animated across all azimuths from 0° to 350° by 10° intervals. Pickell, CC-BY-SA-4.0.")
...
```{r 9-nelson-river-hillshade-animation, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Hillshade of Nelson River pouring into Hudson Bay, Manitoba, Canada. <a href='",baseurl,"#fig:9-nelson-river-hillshade-animation'>Animated figure can be viewed in the web browser version of the textbook</a>Data from Shuttle Radar Topography Mission. Online version is animated across azimuths from 0° to 350° by 10° intervals. Pickell, CC-BY-SA-4.0.")
...
```{r 9-mount-assiniboine-profile-planform-curvature, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Profile and planform curvature for Mount Assiniboine at the border of Alberta and British Columbia, Canada. Data from Canadian Digital Elevation Model. Pickell, CC-BY-SA-4.0.")
...
```{r 9-mount-assiniboine-nelson-river-topographic-position-index, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Comparing Topographic Position Index (TPI) for Mount Assiniboine and the Nelson River. Data from Canadian Digital Elevation Model and MAXAR, respectively. Pickell, CC-BY-SA-4.0.")
...
```{r 9-mount-assiniboine-flow-dir-acc, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("D8 Flow direction and flow accumulation for Mount Assiniboine at the border of Alberta and British Columbia, Canada. Data from Canadian Digital Elevation Model. Pickell, CC-BY-SA-4.0.")
...
```{r 9-Mattivi-et-al-2019-figure-1, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Conceptual figure showing how Topographic Wetness Index (TWI) is a function of (a) upslope area, (b) area and direction of local flow, and (c) the tangent of the local slope angle. Reproduced from Mattivi et al (2019), CC-BY-4.0.")
...
fig_cap <- paste0("Multi-Resolution Valley Bottom Flatness (MRVBF) Computational Components described by Gallant and Dowling 2003. Melser, CC BY 4.0.")
...
fig_cap <- paste0("Input layers and output prediction raster for the Chowade Watershed Management basin.<a href='",baseurl,"#fig:9-leaflet-map'>Animated figure can be viewed in the web browser version of the textbook</a>.Data from City of Vancouver and licensed under the  under the <a href='",covlicence,"'>Open Government License - Vancouver</a>. Lam, CC-BY-SA-4.0.")
```
...
```{r 9-baffin-island-mount-odin-1, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Anaglyph of Mount Odin on Baffin Island, Nunavut, Canada. Imagery by MAXAR. Pickell, CC-BY-SA-4.0.")
...
```{r 9-vancouver-building-height-extruded, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Animation showing building polygons in Vancouver, British Columbia extruded by a height attribute. <a href='",baseurl,"#fig:9-vancouver-building-height-extruded'>Animated figure can be viewed in the web browser version of the textbook</a>. Building data (2009) from City of Vancouver, licensed under <a href='",covlicence,"' Open Government License - Vancouver</a>. Base map © OpenStreetMap contributors, licensed under Open Data Commons Open Database License. Pickell, CC-BY-SA-4.0.")
...
```{r 9-mount-logan-exaggeration, fig.cap = fig_cap, out.width= "75%", echo = FALSE}
    fig_cap <- paste0("Elevation exaggeration of Mount Logan elevation, Yukon Terrotiry, Canada. Digital Elevation Model by Natural Resources Canada, licensed under the <a href='",covlicence,"'>Open Government License - Vancouver</a>. Pickell, CC-BY-SA-4.0.")
