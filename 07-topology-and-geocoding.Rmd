...
```{r setup-3d-alpha-hull-fsc, echo=FALSE, cached=T, warning=F, include=F}
las <- readLAS("Data/07/07-fsc-building.las")
z <- las[,3]-95.01
x <- las[,1]-481887
y <- las[,2]-5456393
xyz <- cbind(x,y,z)
...
rglwidget(width = 600, height = 600, reuse=FALSE, elementId="7-3d-alpha-hull-fsc")
```
