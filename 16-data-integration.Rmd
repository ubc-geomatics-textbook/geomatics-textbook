...
![The Eddy Covariance system at Fish Island [@skeeter_controls_2022]](images/16-ec-site.png){.center}

![Maybe insert Web-map showing site instead [@skeeter_controls_2022]](images/16-fig1.png){.center}
...
![Precision versus accuracy [@davies_precision_2020].](images/16-accuracy-vs-precision.png){.center}

![Accuracy and precision in chronostratigraphy [@davies_accuracy_2020].](images/16-accuracy-vs-precision2.png){.center}
...
![Reference map showing the Mackenzie Delta (Currently from chapter 2, I'll change it to a full delta NDVI map) ](images/16-fig1.png){.center}

![Landscape classification and drone imagery](images/16-fig2.png){.center}

![Footprint NDVI profile](images/16-fig3.png){.center}

![Climate Data](images/16-fig4.png){.center}

![Temporally upscaled flux estimate](images/16-fig5.png){.center}

![Landscape classification based on fig 3](images/16-fig6.png){.center}
