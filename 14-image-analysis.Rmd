...
Four vegetation indices were calculated for each of the images in the study. The Normalized Difference Vegetation Index (NDVI, Rouse et al., 1974), and Tasseled Cap Transformation (TCT, Crist & Cicone, 1984) were calculated to measure vegetation health. NDVI is calculated as (Equation 1):
...
$$\\[0.1in]$$
Additionally, the Normalized Burn Ratio (NBR, García & Caselles, 1991), and the Difference Normalized Burn Ratio (dNBR, Key and Benson, 2006) were calculated. NBR (Equation 2) and the dNBR (Equation 3) are used to measure burn severity.
...
``` {r 14-dnbr-leaflet, echo=FALSE, out.width="75%", fig.cap=fig_cap}
  fig_cap <- paste0("Classified Burn Severity images for the Little Bobtail Lake wildfire from 2015 to 2020.<a
  href='",baseurl,"#fig:14-dnbr-leaflet'>Animated figure can be viewed in the web browser version of the textbook</a>. Data from Natural Resources Canada and licensed under the <a href='",nrcanlicense,">Open Government Licence - Canada </a>.Pickell, CC-BY-SA-4.0.")
if (type == "pdf") { knitr::include_graphics(here::here("images", "02-CGVD-leaflet.PNG")) }
```
...
data---The TM Tasseled Cap. IEEE Transactions on Geoscience and Remote sensing, (3),
256-263.
...
Hesselbarth, M. H., Sciaini, M., & Nowosad, J. (2020, September 17). Landscape Metrics (Version 1.5.0) [Program documentation]. Retrieved 2020, from https://cran.r-project.org/web/packages/landscapemetrics/landscapemetrics.pdf
...
‘FIREMON: fire effects monitoring and inventory system’. (Eds D. C. Lutes, R. E.
Keane, J. F. Caratti, C. H. Key, N. C. Benson, S. Sutherland, L. J. Gangi) USDA Forest
