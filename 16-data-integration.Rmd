...
(ref:16-ec-site-caption) The Eddy Covariance system at Fish Island [@skeeter_controls_2022].

```{r 16-ec-site, fig.cap = fig_cap, out.width= "90%", echo = FALSE}
    fig_cap = "(ref:16-ec-site-caption)"
    knitr::include_graphics("images/16-ec-site.png")
```

(ref:16-fig1-caption) Maybe insert Web-map showing site instead. [@skeeter_controls_2022]

```{r 16-fig1, fig.cap = fig_cap, out.width= "90%", echo = FALSE}
    fig_cap = "(ref:16-fig1-caption)"
...
(ref:16-accuracy-vs-precision-caption) Precision versus accuracy [@davies_precision_2020].

```{r 16-accuracy-vs-precision, fig.cap = fig_cap, out.width= "90%", echo = FALSE}
    fig_cap = "(ref:16-accuracy-vs-precision-caption)"
    knitr::include_graphics("images/16-accuracy-vs-precision.png")
```

(ref:16-accuracy-vs-precision2-caption) Accuracy and precision in chronostratigraphy [@davies_accuracy_2020].

```{r 16-accuracy-vs-precision2, fig.cap = fig_cap, out.width= "100%", echo = FALSE}
    fig_cap = "(ref:16-accuracy-vs-precision2-caption)"
...
(ref:16-flux-upscaling-estimate-caption) Rough flowchart draft.

```{r 16-flux-upscaling-estimate, fig.cap = fig_cap, out.width= "100%", echo = FALSE}
    fig_cap = "(ref:16-flux-upscaling-estimate-caption)"
    knitr::include_graphics("images/16-flux-upscaling-estimate.png")
```

(ref:16-fig1-2-caption) Reference map showing the Mackenzie Delta (Currently from chapter 2, I'll change it to a full delta NDVI map).

```{r 16-fig1-2, fig.cap = fig_cap, out.width= "100%", echo = FALSE}
    fig_cap = "(ref:16-fig1-2-caption)"
    knitr::include_graphics("images/16-fig1.png")
```

(ref:16-fig2-caption) Landscape classification and drone imagery.

```{r 16-fig2, fig.cap = fig_cap, out.width= "100%", echo = FALSE}
    fig_cap = "(ref:16-fig2-caption)"
    knitr::include_graphics("images/16-fig2.png")
```

(ref:16-fig3-caption) Footprint NDVI profile.

```{r 16-fig3, fig.cap = fig_cap, out.width= "100%", echo = FALSE}
    fig_cap = "(ref:16-fig3-caption)"
    knitr::include_graphics("images/16-fig3.png")
```

(ref:16-fig4-caption) Climate Data.

```{r 16-fig4, fig.cap = fig_cap, out.width= "100%", echo = FALSE}
    fig_cap = "(ref:16-fig4-caption)"
    knitr::include_graphics("images/16-fig4.png")
```

(ref:16-fig5-caption) Temporally upscaled flux estimate.

```{r 16-fig5, fig.cap = fig_cap, out.width= "100%", echo = FALSE}
    fig_cap = "(ref:16-fig5-caption)"
    knitr::include_graphics("images/16-fig5.png")
```

(ref:16-fig6-caption) Landscape classification.

```{r 16-fig6, fig.cap = fig_cap, out.width= "100%", echo = FALSE}
    fig_cap = "(ref:16-fig6-caption)"
