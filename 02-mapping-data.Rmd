...
fig_cap <- paste("The difference (in meters) between the Canadian Geodetic Vertical Datum of 2013 (CGVD2013) and the Canadian Geodetic Vertical Datum of 1928 (CGVD28). Data from Natural Resources Canada and licensed under the <a href='",nrcanlicense,"'> Open Government Licence <a> - Canada. Animated figure can be viewed in the web broswer version of the textbook. Pickell, CC-BY-SA-4.0.")
m
```
